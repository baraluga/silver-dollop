...
const mockProcessQueryWithAI = processQueryWithAI as jest.MockedFunction<
  typeof processQueryWithAI
>;
...
describe("Insights API", () => {
  ...
  describe("POST /api/insights", () => {
    it("should call AI strategy and return insights", async () => {
      ...
      expect(mockProcessQueryWithAI).toHaveBeenCalledWith(
        "What is our team's current availability?",
      );
    ...
    it("should handle AI strategy errors", async () => {
      mockProcessQueryWithAI.mockRejectedValue(
