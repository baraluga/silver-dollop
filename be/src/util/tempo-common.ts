...
export class TempoCommon {
  ...
  static filterUserWorklogs(userId: string, worklogs: TempoWorklog[]): TempoWorklog[] {
  ...
  static extractUniqueUserIdsFromPlansAndWorklogs(plans: TempoPlan[], worklogs: TempoWorklog[]): string[] {
  ...
  private static addUserIdIfValid(user: { accountId?: string; id?: string } | undefined, userIds: Set<string>): void {
