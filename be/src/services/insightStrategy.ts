...
const mockInsights = {
  availability: {
    ...
    summary:
      "Based on current Tempo Planner data, here's your team's availability for the next sprint:",
    insights: [
  ...
  billability: {
    ...
    summary:
      "Here's your team's billability performance for this month based on Tempo time logs:",
    insights: [
